...
remove_epsilon_moves(G, [Edge | T]) ->
    ...
    case EdgeInfo of
        {EpsEdgeToDel, VLeft, VRight, Label} when ((Label =:= 'ɛ') and (VLeft =/= VRight)) ->
            if
                    ...
                    lists:foreach(
                        fun(EToAdd) ->
                            ...
                            if
                                ...
                                EToAdd =/= EpsEdgeToDel -> digraph:add_edge(G, VRight, V, ELabel);
                                true -> ?UNDEFINED
                            end
                        end,
                        EOut
                ...
                VLeft =:= 1 ->
                    ...
                    lists:foreach(
                        fun(EToAdd) ->
                            ...
                            if
                                EToAdd =/= EpsEdgeToDel -> digraph:add_edge(G, V, VLeft, ELabel);
                                true -> ?UNDEFINED
                            end
                        end,
                        EIn
